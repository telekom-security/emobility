...
public class SchemaVersion extends TableImpl<SchemaVersionRecord> {
	...
	private static final long serialVersionUID = 139417643;
	...
	/**
	 * The column <code>stevedb.schema_version.version_rank</code>.
	 */
	 ...
	 */
	public final TableField<SchemaVersionRecord, DateTime> INSTALLED_ON = createField("installed_on", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaulted(true), this, "", new DateTimeConverter());
