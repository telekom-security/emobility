...
public enum ReservationStatus {
	...
	ACCEPTED("Accepted"), @XmlEnumValue("Faulted")
	FAULTED("Faulted"), @XmlEnumValue("Occupied")
	OCCUPIED("Occupied"), @XmlEnumValue("Rejected")
	REJECTED("Rejected"), @XmlEnumValue("Unavailable")
