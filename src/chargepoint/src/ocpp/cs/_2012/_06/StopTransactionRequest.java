...
@XmlType(name = "StopTransactionRequest", propOrder = { "transactionId",
		"idTag", "timestamp", "meterStop", "transactionData" })
public class StopTransactionRequest {
	 ...
	 * <CODE>set</CODE> method for the transactionData property.
	 * 
	 * <p>
